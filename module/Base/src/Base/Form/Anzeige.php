...
class Anzeige extends Form\Form {
...
//        $this->setHydrator(new Hydrator\ClassMethods());
        $this->setHydrator(new Hydrator\Anzeige());
        
        $this->setObject(new Entity\Anzeige());
...
//    }
    ...
    public function getId() {
        ...
        if(empty($this->id)){
            ...
            $id = new Form\Element\Hidden(C::ANZEIGE_ID);
...
//            $id->setLabel(self::LABEL_ID);
    ...
    public function getUrlId() {
        ...
        if(empty($this->urlId)){
            ...
            $urlId = new Form\Element\Hidden(C::ANZEIGE_URL_ID);
...
//            $urlId->setAttribute('class', 'input-xlarge');
    ...
    public function getUserId() {
        ...
        if(empty($this->userId)){
            ...
            $userId = new Form\Element\Text(C::ANZEIGE_USER_ID);
